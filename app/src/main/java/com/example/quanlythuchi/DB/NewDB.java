...
public class NewDB {
	private static final String DATABASE_NAME = "DB_QL";
	...
	public NewDB(Context c){
		NewDB.context = c;
	}
	
	public NewDB open() throws SQLException{
	...
	public long createUser(String tenDN, String matKhau) {		
